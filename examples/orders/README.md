...
module that downstream library users import. Both modules currently
pin `go 1.25.0`; the adapter root bumped to 1.25 in the v0.4.0 cycle
when `eventbus/outbox/pgx` landed.
