module github.com/slam0504/go-ddd-adapters/examples/orders

go 1.25.0

replace github.com/slam0504/go-ddd-adapters => ../..
...
require (
	...
	github.com/slam0504/go-ddd-core v0.11.1-0.20260702035204-128d9eb1932a
